...
export function updatePersonalLink(
  link: PersonalLink,
...
export function createPersonalLinkList(owner: {
  group: any
}): PersonalLinkLists {
  return PersonalLinkLists.create([], { owner: owner.group })
}

export function addToPersonalLinkList(
...
export function removeFromPersonalLinkList(
  list: PersonalLinkLists,
  id: ID<PersonalLink>,
): void {
